        ...
        <div class="col-md-12 p-5 pt-3">
            <div class="card card-outline card-primary form-card">
                <div class="card-header">
                    <h3 class="card-title pt-2 pb-2"> Create New Vaccine </h3>
                ...
                <div class="card-body demo-vertical-spacing">
                    ...
                    <div class="input-group row {{$errors->has('manufacturer') ? 'has-error' : ''}}">
                        ...
                        <div class="col-md-9">
                            {!! Form::textarea('manufacturer', old('manufacturer'), ['class' => 'form-control', 'rows' => 2]) !!}
                    ...
                    <div class="input-group row {{$errors->has('doses_required') ? 'has-error' : ''}}">
                        ...
                        <div class="col-md-9">
                            {!! Form::select('doses_required', [0 => 'No', 1 => 'Yes'], old('doses_required'), ['class' => 'form-control required']) !!}
                    ...
                    <div class="input-group row {{$errors->has('age_due_days') ? 'has-error' : ''}}">
                        ...
                        <div class="col-md-9">
                            {!! Form::number('age_due_days', old('age_due_days'), ['class' => 'form-control required', 'min' => 0]) !!}
                    ...
                    <div class="input-group row {{$errors->has('number_of_doses') ? 'has-error' : ''}}">
                        ...
                        <div class="col-md-9">
                            {!! Form::number('number_of_doses', old('number_of_doses'), ['class' => 'form-control required', 'min' => 1]) !!}
                    ...
                    <div class="input-group row {{$errors->has('dose_interval_days') ? 'has-error' : ''}}">
                        ...
                        <div class="col-md-9">
                            {!! Form::number('dose_interval_days', old('dose_interval_days'), ['class' => 'form-control required', 'min' => 0]) !!}
